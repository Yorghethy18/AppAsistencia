                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="../PHP/horas_diarias.php">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="../PHP/layout-static.php">Formulario Trabajadores</a>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Ausencia - DIARIO</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="../PHP/admnistracion.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">Consulta de Ausencia</li>
                        </ol>
                        <form action="../PHP/ausenciaDi.php" method="post">
							<label for="fecha">Fecha a solicitar:</label>
